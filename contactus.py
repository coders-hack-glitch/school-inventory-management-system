...
class contact:
    def __init__(self, root):
        ...
        Label(c1, text='+91 9319166096', font=('Segoe UI', 12, 'bold'), bg='white', fg=COLORS['blue_dark']).place(x=25,y=105)
        Label(c1, text='Email', font=('Segoe UI', 9, 'bold'), bg='white', fg=COLORS['muted']).place(x=25,y=150)
        Label(c1, text='gargshivyansh80@gmail.com', font=('Segoe UI', 11), bg='white', fg=COLORS['text']).place(x=25,y=173)
        ...
        Label(c2, text='Thank you for using our Application.', font=('Segoe UI', 10), bg='white', fg=COLORS['muted']).place(x=25,y=230)
